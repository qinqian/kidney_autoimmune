...
#thresh = filters.threshold_otsu(gray)
## scale it down a bit
#thresh = thresh * 0.5  # keep more tissue
#mask = gray > thresh

from skimage.filters import threshold_local

block_size = 21  # try different odd numbers
...
ax[1].set_xlim(1700, 2100)
ax[1].set_ylim(900, 1200)
#ax[1].invert_yaxis()
#ax[1].invert_yaxis()
ax[2].imshow(I_warped, alpha=1, origin='lower')
ax[2].set_xlim(3000, 3500)
ax[2].set_ylim(1500, 1800)
ax[3].imshow(I_warped, alpha=1, origin='lower')
ax[3].set_xlim(1900, 2100)
ax[3].set_ylim(1400, 1600)
ax[4].imshow(I_warped, alpha=1, origin='lower')
ax[4].set_xlim(1000, 1200)
ax[4].set_ylim(1000, 1150)
#ax[2].invert_yaxis()
#ax[2].invert_yaxis()
for ax in ax:
    ax.set_aspect('auto')
plt.tight_layout()
fig.savefig("SuppFig3_part1.png", dpi=350)
